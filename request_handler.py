...
from views import get_all_metals, get_all_orders, get_all_styles, get_all_sizes, get_single_metal, get_single_style, get_single_size, get_single_order, create_order, delete_order, update_order
